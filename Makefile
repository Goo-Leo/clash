...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/Goo-Leo/clash/constant.Version=$(VERSION)" \
		-X "github.com/Goo-Leo/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
